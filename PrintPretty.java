    ...
    public static int[][] showPath(int[][] arr, String path_str) {
        ...
        for (int i = 1; i < coords.length-1; i++){
            ...
            if(curr_pair[0] == prev_pair[0] && curr_pair[1] > prev_pair[1]) { //пришли с севера
                    ...
                    } else {arr [curr_pair[1]-1][curr_pair[0]-1]= -8;} // на запад
                    ...
                    } else {arr [curr_pair[1]][curr_pair[0]]= -6;} // на восток
                ...
                if(curr_pair[1] == next_pair[1]){ //на восток
                    ...
                    arr [curr_pair[1]][curr_pair[0]]= -7;
                } else {arr [curr_pair[1]][curr_pair[0]]= -5;} // на юг
                ...
                } else {arr [curr_pair[1]][curr_pair[0]]= -6;} // на юг
            }
//            System.out.print(Arrays.toString(prev_pair));
//            System.out.print(" ");
//            System.out.print(Arrays.toString(curr_pair));
//            System.out.print(" ");
//            System.out.print(Arrays.toString(next_pair));
//            System.out.print(" ");
//            System.out.println(arr[curr_pair[0]] [curr_pair[1]]);
